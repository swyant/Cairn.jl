...
pce_higher_order.params = [67907.56073774067, -236495.6277340431, -94438.21720006624, -1.1027943198011185e6, 2.601195430270954e6,
...
@testset "GreedySelector tests" begin
    ...
    updated_trainset, new_configs = update_trainset!(gs,main_msys,ss_test_al)
    ...
    @test new_configs[1].boundary == main_msys.boundary
